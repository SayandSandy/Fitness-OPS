        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-[#17191C] px-2 text-[var(--theme-muted)] uppercase tracking-widest">or continue with</span>
            </div>
          </div>
        </div>
              ...
              <div>
                ...
                {isLogin && (
                  <div className="flex justify-end mt-2">
                    <button type="button" className="text-[10px] text-[var(--theme-orange)] hover:underline uppercase tracking-widest" onClick={() => alert("Contact command to reset your clearance code.")}>
                      Forgot Password?
                    </button>
                  </div>
                )}
